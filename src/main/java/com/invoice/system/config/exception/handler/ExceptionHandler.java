...
public class ExceptionHandler {
  @org.springframework.web.bind.annotation.ExceptionHandler(VendorNotFoundException.class)
  public ResponseEntity<ErrorDetails> handleNotFound(VendorNotFoundException ex) {
